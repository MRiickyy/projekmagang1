...
@section('title', 'Detail Author Information')
...
<main class="flex-1 flex justify-center items-start px-4 py-10">
    <div class="w-full max-w-3xl bg-[#F2F6F9] rounded-lg shadow-xl p-6 text-slate-800">
        ...
        <h2 class="text-base font-semibold text-slate-900 mb-6">Detail Author Information</h2>
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                <input type="text" id="section" value="{{ $authorInfo->section ?? '' }}"
            ...
            <div>
                ...
                <textarea id="content" rows="8" readonly disabled
                    class="w-full border border-gray-400 bg-gray-200 rounded-md px-3 py-2 text-gray-700 cursor-not-allowed">{{ $authorInfo->content ?? '' }}</textarea>
            </div>

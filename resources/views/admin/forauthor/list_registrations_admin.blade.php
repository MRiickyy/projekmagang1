...
<div class="flex-1 flex flex-col">
    ...
    <section id="registration" class="tabcontent px-6 py-6 hidden">
        <div class="bg-[#F2F6F9] shadow-md rounded-lg p-6 w-full overflow-x-auto">
            ...
            <table class="min-w-max w-full border border-gray-300 rounded-lg">
                <thead class="bg-gray-200 text-slate-900">
                    <tr>
                        <th class="px-4 py-2 border">No</th>
                        <th class="px-4 py-2 border">Section</th>
                        <th class="px-4 py-2 border max-w-[350px]">Content</th>
                ...
                <tbody class="bg-white text-slate-800">
                    ...
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2 border max-w-[350px] whitespace-normal break-words">
    ...
    <div class="bg-[#F2F6F9] shadow-md rounded-lg p-6 w-full overflow-x-auto">
        ...
        <table id="paymentTable" class="min-w-max w-full border border-gray-300 rounded-lg">
            <thead id="paymentHead" class="bg-gray-200 text-slate-900"></thead>
            ...
            <tbody class="bg-white text-slate-800">
                ...
                <tr class="hover:bg-gray-100"
                    ...
                    <!-- Action -->
                    <td class="px-4 py-2 border action-col">
                        <div class="flex justify-center gap-2">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderTable(type) {
        ...
        rows.forEach(row => {
            ...
            if (rowType === type) {
                row.style.display = '';
                row.querySelector('.number-col').textContent = visibleCount++;

                row.querySelectorAll('.va-col').forEach(c => c.classList.toggle('hidden', type !== 'va'));
                row.querySelectorAll('.paypal-col').forEach(c => c.classList.toggle('hidden', type !== 'paypal'));
            } else {

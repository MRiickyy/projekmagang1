...
<main class="flex-1 flex justify-center items-start px-4 py-10">
    <div class="w-full max-w-3xl bg-[#F2F6F9] rounded-lg shadow-xl p-6 text-slate-800">
        ...
        <form action="{{ route('admin.forauthor.update_authorinformation') }}" method="POST"
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title', $authorInfo->title ?? '') }}"
            ...
            <div>
                ...
                <input type="text" name="cta_text" value="{{ old('cta_text', $authorInfo->cta_text ?? '') }}"
                    class="w-full border border-gray-400 bg-gray-100 rounded-md px-3 py-2 focus:outline-none" />
            </div>
            ...
            <div>
                ...
                <input type="text" name="cta_button" value="{{ old('cta_button', $authorInfo->cta_button ?? '') }}"
                    class="w-full border border-gray-400 bg-gray-100 rounded-md px-3 py-2 focus:outline-none" />
            </div>
            ...
            <div>
                ...
                <input type="text" name="cta_link" value="{{ old('cta_link', $authorInfo->cta_link ?? '') }}"
                    class="w-full border border-gray-400 bg-gray-100 rounded-md px-3 py-2 focus:outline-none" />
            </div>
            ...
            <!-- Selection Process -->
            <div>
                <label class="block text-sm font-bold text-slate-900 mb-1" for="selection_process">Selection
                    Process</label>
            ...
            <div>
                <label class="block text-sm font-bold text-slate-900 mb-1"
                    for="preparation_of_contributions">Preparation of Contributions</label>
            ...
            <div>
                <label class="block text-sm font-bold text-slate-900 mb-1" for="non_presented_policy">Non Presented
                    Policy</label>

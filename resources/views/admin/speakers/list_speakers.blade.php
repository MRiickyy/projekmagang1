...
<div class="w-full bg-[#F2F6F9] rounded-lg shadow-xl p-6 text-slate-800">
    ...
    <div class="flex justify-between mb-4 items-center">
        ...
        <!-- Form Filter -->
        <form method="GET" action="{{ route('admin.speakers') }}" class="flex gap-3 items-center">
        ...
        <table class="w-full border border-gray-300 rounded-lg overflow-hidden">
            ...
            <tbody class="bg-white text-slate-800">
                ...
                <tr class="hover:bg-gray-100">
                    <td class="px-4 py-2 border">{{ $loop->iteration + ($speakers->currentPage() - 1) * $speakers->perPage() }}</td>
                    ...
                    <td class="px-4 py-2 border">{{ $speaker->speaker_type }}</td>

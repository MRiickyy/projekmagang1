...
<div class="w-full bg-[#F2F6F9] rounded-lg shadow-xl p-6 text-slate-800">
    ...
    <div class="flex justify-between mb-4 items-center">
        ...
        <!-- Form Filter -->
        <form method="GET" action="{{ route('admin.committees.' . str_replace(' ', '_', $type)) }}" class="flex gap-3 items-center">
            ...
            <tbody class="bg-white text-slate-800">
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="px-4 py-2 border">
                        <div class="flex justify-center gap-2">
                            ...
                            <form action="{{ route('delete.committees', $committee->id) }}"
                ...
                <tr>
                    <td colspan="9" class="text-center py-4 text-gray-500">
                        No committees found for {{ ucfirst($type) }}.
                    </td>
                </tr>
                @endforelse
            </tbody>

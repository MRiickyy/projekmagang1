        ...
        <div class="hidden md:flex items-center gap-8 font-semibold text-slate-200">
            ...
            <div class="relative dropdown">
                ...
                <div
                    ...
                    <a href="/TPC" class="block px-4 py-2 text-sm hover:bg-[#2d3748]">Technical Program Committees</a>
                    <a href="/organizing-committee" class="block px-4 py-2 text-sm hover:bg-[#2d3748]">Organizing Committees</a>
                </div>
            </div>

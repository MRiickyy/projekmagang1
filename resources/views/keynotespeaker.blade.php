    ...
    <div class="bg-gray-100 rounded-lg shadow-md flex items-start mb-6 overflow-hidden">
        ...
        <div class="flex flex-col justify-between p-4 flex-1">
            <div>
                ...
                <div class="relative">
                    <p id="desc" class="text-sm leading-relaxed max-h-24 overflow-hidden transition-all duration-500">
                        Prof. <strong>Eisuke Kita</strong> (北 栄祐) is a dean and a professor at the Graduate School of
                        Informatics
                        of <strong>Nagoya University</strong>. He received his Doctor of Engineering degree from the
                        Graduate
                        School of Engineering of Nagoya University. His research fields include mathematical model of
                        vehicle
                        platoon and traffic flow control. Prof. Kita has also contributed to various international
                        collaborations
                        in traffic systems...
                    </p>

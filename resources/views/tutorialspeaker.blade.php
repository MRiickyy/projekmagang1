...
<head>
    ...
    <title>ICOICT 2025 - Tutorial Speakers</title>
...
<body class="font-sans bg-gray-100 text-gray-800">
    ...
    <nav class="bg-[#1a1f27]/95 backdrop-blur supports-backdrop-blur sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-5 py-4 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-8 font-semibold text-slate-200">
                ...
                <a href="/speakers" class="hover:text-[#9ae6b4]">Speakers</a>
    ...
    <section class="max-w-5xl mx-auto my-12 px-6">
        <h3 class="text-center text-2xl font-bold mb-10">TUTORIAL SPEAKER</h3>
            ...
            <div class="flex flex-col justify-between p-4 flex-1">
                <div>
                    ...
                    <p class="text-sm leading-relaxed mb-3">
                        Prof. Eisuke Kita (北 栄祐) is a dean and a professor at the Graduate School of Informatics of Nagoya
                        University. He received his Doctor of Engineering degree from the Graduate School of Engineering of
                        Nagoya University. His Research fields include mathematical model of vehicle platoon and traffic flow
                        control.
                    </p>
                </div>
                <a href="#"
                    class="self-end bg-[#0a2a43] hover:bg-[#103d60] text-white px-5 py-2 rounded-full text-sm">Read More ›</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md flex items-start mb-6 overflow-hidden">
            ...
            <div class="flex flex-col justify-between p-4 flex-1">
                <div>
                    ...
                    <p class="text-sm leading-relaxed mb-3">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris euismod, nisl eget consequat
                        ullamcorper, elit orci malesuada nulla, sit amet viverra eros lorem et nunc.
                    </p>
                </div>
                <a href="#"
                    class="self-end bg-[#0a2a43] hover:bg-[#103d60] text-white px-5 py-2 rounded-full text-sm">Read More ›</a>
    ...
    <footer class="mt-10 bg-gradient-to-br from-[#0f172a] to-[#1f2937]">
        <div class="max-w-7xl mx-auto px-5 py-10 grid md:grid-cols-3 gap-6 text-white">

...
class CallPaperSeeder extends Seeder
{
    public function run(): void
    {
        ...
        3. The length of the submitted paper is at least 12 pages and no more than 15 pages in A4 Paper size.
        4. The paper format is as follows:
        ...
        5. All review processes are blind peer reviews by a minimum of three reviewers.
        6. All review processes are single-blind peer reviews.
        7. Full paper must be submitted through sain@ijain.org or (https://cmt3.research.microsoft.com/User/Login?ReturnUrl=%2FSAIN2025%2FSubmission%2Findex) Microsoft Submission Management system.
        8. Please contact ijain@uad.ac.id and/or andri.pranolo.id@ieee.org for any questions."]
        );
